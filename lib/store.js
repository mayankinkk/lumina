...
const useStore = create((set, get) => ({
  ...
  hydrate: async () => {
    ...
    set({ books, vocabulary, notes, highlights, readingSessions, bookmarks, readingQueue, dailyGoal, weeklyGoal, goalMode, customThemeColors, autoHideToolbar, tapZones, fileCache, _hydrated: true });
  },
